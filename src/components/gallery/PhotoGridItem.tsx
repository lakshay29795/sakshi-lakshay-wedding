...
export function PhotoGridItem({ photo, index, onClick, className }: PhotoGridItemProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group relative cursor-pointer overflow-hidden rounded-lg bg-soft-gray',
    ...
    >
      ...
      {/* Error State */}
      {isError && (
        <div className="aspect-square flex items-center justify-center bg-soft-gray text-muted-foreground">
